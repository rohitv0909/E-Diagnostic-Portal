...
<body style="background-image: url('/ediagnostic/images/i1.jpg');">
	<%
		String ms = (String) request.getAttribute("msg");
	%>
	<div style="width: 55%; height: 200px; float: left; font-size: 40px; margin-left: 5%; color: red;">E-Diagnostic Portal</div>
	<div style="width: 40%; height: 200px; float: left">

		<div style="width: 80px; float: left; margin-top: 5px">
			<a href="/ediagnostic/jsp/home.jsp">Home</a>
		</div>
	...
	<div
		...
		<form action="/ediagnostic/Login1" method="post"
