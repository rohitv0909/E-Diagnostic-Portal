...
<body>
	<div
		...
		<h1 style="text-align: center;">VIEW WORKER ACCOUNTS</h1>
	</div>
	...
	<div
		...
		%>
		<table border=1>
		<tr><th>Worker ID</th><th>Name</th><th>Address</th><th>Phone No.</th><th>Email</th>
		</tr>
		<%
		while(rs.next())
		{
		%>
		<tr><th><%=rs.getString("workerid") %></th>
