...
function main() 
{
	...
	{
		document.getElementById("msgtitle").innerHTML = "Please enter title of the news"
	...
	{
		document.getElementById("msgcontents").innerHTML = "Please enter content of the news"
...
<body>
	...
	<div
		...
		<form action="/ediagnostic/AddNews1" method="post" onsubmit="return main()">
		<table style="margin-left: 400px; margin-top: 150px">
		<tr><th>Title</th><th><input type="text" name="txttitle" id="txttitle"
		placeholder="Please enter title of the news"></th>
		</tr>
		<tr><td colspan="2" id="msgtitle" style="color: red"></th></tr>
		<tr><th>Contents</th><th><textarea name="txtcontents" id="txtcontents" rows="5" placeholder="Please enter content of the news"></textarea></th>
		</tr>
